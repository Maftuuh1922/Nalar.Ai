...
export default function Modal({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/15 backdrop-blur-sm animate-in fade-in duration-300"
    >
      <div
        ref={dialogRef}
        role="dialog"
        ...
        className={`relative flex flex-col overflow-hidden rounded-xl border border-[var(--border)]/60 bg-[var(--popover)]/75 shadow-2xl backdrop-blur-2xl transition-all animate-in zoom-in-95 duration-300 ${widthClasses[width]} max-h-[85vh]`}
      >
        {/* Header */}
