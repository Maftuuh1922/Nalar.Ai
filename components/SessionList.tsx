    ...
    return (
      <div className="py-0.5">
        {sessions.map((session, index) => {
          ...
          return (
            <div
              key={session.session_id || session.id || `session-${index}`}
              ...
              role="button"
              tabIndex={0}
              className={`group flex items-center gap-2 rounded-[7px] px-2 py-1.5 transition-colors duration-100 active:scale-[0.98] ${
                active
