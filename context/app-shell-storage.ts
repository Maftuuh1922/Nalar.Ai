...
export const ACTIVE_SESSION_STORAGE_KEY = "nalar-ai.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "nalar-ai-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "nalar-ai.sidebarCollapsed";
export const CHAT_RESPONSE_TIMEOUT_STORAGE_KEY =
  "nalar-ai.chatResponseTimeout";
export const CODE_BLOCK_THEME_STORAGE_KEY = "nalar-ai.code-block-theme";
export const CODE_BLOCK_SHOW_LINE_NUMBERS_STORAGE_KEY =
  "nalar-ai.code-block-show-line-numbers";
export const CODE_BLOCK_WRAP_LONG_LINES_STORAGE_KEY =
  "nalar-ai.code-block-wrap-long-lines";
...
export const ACTIVE_SESSION_EVENT = "nalar-ai:active-session";
export const LANGUAGE_EVENT = "nalar-ai:language";
export const SIDEBAR_COLLAPSED_EVENT = "nalar-ai:sidebar-collapsed";
export const CODE_BLOCK_SETTINGS_EVENT = "nalar-ai:code-block-settings";
