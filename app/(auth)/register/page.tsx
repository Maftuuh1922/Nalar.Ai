  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="text-center mb-8">
        <h1 className="font-sans text-3xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent tracking-tight">
          Nalar AI
        </h1>
      ...
      {/* Card */}
      <div className="relative bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-xl px-8 py-8 backdrop-blur-md bg-opacity-90 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-lg font-medium text-sm
                       bg-gradient-to-r from-[var(--primary)] to-[var(--primary)]/90 text-[var(--primary-foreground)]
      ...
      <p className="mt-3 text-center text-xs text-[var(--muted-foreground)]">
        Nalar AI · Agent-Native Learning
      </p>
    </div>
  );
}
