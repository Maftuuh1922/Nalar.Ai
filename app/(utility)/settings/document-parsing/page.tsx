...
const PIP_HINT: Record<string, string> = {
  docling: "pip install nalar-ai[parse-docling]",
  markitdown: "pip install nalar-ai[parse-markitdown]",
  pymupdf4llm: "pip install nalar-ai[parse-pymupdf4llm]",
};
  ...
  return (
    ...
    >
      <SettingRow
        ...
        description={t(
          "Reserved — uses Nalar AI's vision model to caption images during conversion.",
        )}
        control={
          <Toggle
            checked={llmImages}
