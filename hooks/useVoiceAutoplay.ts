...
const SESSION_KEY_PREFIX = "nalar-ai.voiceAutoplay.session"; // "on" | "off"
const PROMPTED_KEY_PREFIX = "nalar-ai.voiceAutoplay.prompted"; // "1"
const GLOBAL_EVENT = "nalar-ai:voice-autoplay-global";
const SESSION_EVENT = "nalar-ai:voice-autoplay-session";
