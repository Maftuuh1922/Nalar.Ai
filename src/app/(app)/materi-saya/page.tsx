  ...
  return (
    <div className="flex h-full flex-col bg-transparent">
      <div className="flex items-center justify-between border-b border-cloudy/10 px-8 py-6">
        <div>
          <h1 className="text-2xl font-bold font-serif text-gray-900">Materi Saya</h1>
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          {/* Upload Area */}
          <div 
            className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-cloudy/30 bg-pampas py-12 transition-colors hover:bg-cloudy/5"
            ...
            {isUploading ? (
              ...
              <div className="flex cursor-pointer flex-col items-center text-center">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-sm">
                  <UploadCloud className="h-6 w-6 text-gray-900" />
                </div>
                <p className="text-sm font-bold text-gray-900">Klik untuk mengunggah dokumen baru</p>
          ...
          <div>
            ...
            {isLoading ? (
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {documents.map(doc => (
                  <div key={doc.id} className="group flex flex-col justify-between rounded-xl border border-cloudy/20 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                    <div className="flex items-start gap-3">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-pampas">
