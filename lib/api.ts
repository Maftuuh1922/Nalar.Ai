 ...
 * `NALAR_AI_API_BASE_URL` (exported by the container entrypoint from
...
/**
 * Parse a "NALAR_AI_AUTH_ENABLED"-style flag at runtime.
 *
...
// The browser bundle never sees `NALAR_AI_AUTH_ENABLED` (it isn't a
